  ...
  return (
    <div className="relative w-[1440px] h-[1024px] bg-[#D7E9ED] rounded-[30px] overflow-hidden mx-auto my-4">
      ...
      <input
        ...
        className="absolute left-[681px] top-[451px] w-[459px] h-[63px] rounded-[30px] px-6 bg-[rgba(43,108,99,0.1)] text-black placeholder-black caret-black outline-none border-2 border-black focus:ring-0 shadow-none"
      ...
      {message && (
        <div 
          className="absolute left-[680px] top-[550px] w-[459px] h-[20px] flex items-center justify-center text-center"
          style={{ 
      ...
      <button
        ...
        disabled={loading}
      >
        <span className="text-[20px] leading-[26px] text-[#D7E9ED]">
